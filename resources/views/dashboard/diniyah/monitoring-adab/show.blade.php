...
@section('title', 'Monitoring Adab - ' . $santri->name)

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ tenant_route('dashboard.diniyah.monitoring-adab.index', ['programSlug' => $programSlug]) }}" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">
            <i class="fa-solid fa-arrow-left"></i>
        </a>
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Monitoring Adab — {{ $santri->name }}</h1>
    ...
    @if($records->isEmpty())
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-12 text-center">
            <p class="text-gray-500 dark:text-gray-400">Belum ada data monitoring adab untuk santri ini.</p>
        </div>
    @else
