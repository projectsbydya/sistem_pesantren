...
<div class="max-w-6xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-4">
            <a href="{{ tenant_route('dashboard.diniyah.monitoring-adab.index', ['programSlug' => $programSlug]) }}" class="p-2 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <i class="fa-solid fa-arrow-left"></i>
            </a>
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Riwayat Monitoring Adab</h1>
    ...
    @if($records->isEmpty())
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-12 text-center">
            <div class="w-16 h-16 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4">
                <i class="fa-solid fa-hand-holding-heart text-gray-400 dark:text-gray-500 text-2xl"></i>
            </div>
            <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-1">Belum ada data</h3>
            <p class="text-gray-500 dark:text-gray-400">Santri belum memiliki riwayat monitoring adab.</p>
        </div>
    @else
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 dark:bg-gray-800">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Aspek Adab</th>
