...
<div class="max-w-6xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-4">
            <a href="{{ tenant_route('dashboard.diniyah.nilai-akhlak.index', ['programSlug' => $programSlug]) }}" class="p-2 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <i class="fa-solid fa-arrow-left"></i>
            </a>
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Riwayat Nilai Akhlak</h1>
    ...
    @if($records->isEmpty())
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-12 text-center">
            ...
            <p class="text-gray-500 dark:text-gray-400">Santri belum memiliki riwayat nilai akhlak.</p>
        </div>
    @else
