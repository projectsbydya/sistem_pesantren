...
@section('title', 'Edit Jadwal ' . strtoupper($programSlug))
@section('breadcrumb')
...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">Edit Jadwal {{ $program->name }}</h1>
</div>
...
<x-card>
    ...
    @include('dashboard.jadwal._form', [
        'action' => tenant_route('dashboard.akademik.jadwal.update', ['programSlug' => $programSlug, 'id' => $schedule->id]),
        'method' => 'PUT',
